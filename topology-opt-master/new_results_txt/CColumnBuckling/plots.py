...
def build_subplot():
    ...
    A = dict()
    A[0] = np.loadtxt('new_results_txt\CColumnBuckling\C1_Column 60x30[p=3, buckling=0.053, vol=0.3]_densities.dat')
    A[1] = np.loadtxt('new_results_txt\CColumnBuckling\C2nN_final_Column 60x30[p=3, buckling=0.080, vol=0.3]_densities.dat')
    ...
    fig, ((axs[0], axs[1])) = plt.subplots(1, 2, figsize=(7,3.5))
