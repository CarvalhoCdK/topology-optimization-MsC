...
from groups.direct_stability_group_no_filter import DirectStabilityGroupNoFilter
...
penal_factor = 1.484   #3.0
volume_fraction = 0.3
filter_radius = 2.0
buckling_load = 0.080 ##Bases_Column [0.053,  0.080, 0.106, 0.133]
                    ## Bases_Hinge [0.697, 1.046, 1.395, 1.744]


xt = 0.8#np.loadtxt('C0_final_Column 60x30[p=3, buckling=0.0, vol=0.3]_densities.dat]_densities.dat') #0.3
initial_densities = xt

## DATA RECORDER
data_recorder = DataRecorder('VarDensity_HD_C2_final_Column 100x50[p=3, buckling=0.080, vol=0.3]',
                            nelx=nelx,
                            nely=nely,
...
#xt = np.loadtxt('VarDensity_A4_final_Column 60x30[p=3, buckling=0.133, vol=0.3]_densities.dat')
#xt = np.loadtxt('C1_final_Column 60x30[p=3, buckling=0.053, vol=0.3]_densities.dat]_densities.dat')
