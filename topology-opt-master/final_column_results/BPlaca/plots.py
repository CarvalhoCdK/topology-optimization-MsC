...
def build_subplot():
    ...
    A = dict()
    A[0] = np.loadtxt('nPlate_60x30_B0_densities.dat')
    A[1] = np.loadtxt('nPlate_60x30_B1_densities.dat')
    A[2] = np.loadtxt('nPlate_60x30_Bb[0.37]_densities.dat')
    A[3] = np.loadtxt('nPlate_60x30_Bb[0.1964, Pc=0.8]_densities.dat')
