...
def build_subplot():
    ...
    A = dict()
    A[0] = np.loadtxt('new_results_txt\APlaca\Plate_60x30_A0_densities.dat')
    A[1] = np.loadtxt('new_results_txt\APlaca\Plate_60x30_A2_densities.dat')
    A[2] = np.loadtxt('new_results_txt\APlaca\Plate_60x30_A3_densities.dat')
    A[3] = np.loadtxt('new_results_txt\APlaca\Plate_60x30_A4_densities.dat')
