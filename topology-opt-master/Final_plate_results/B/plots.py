...
def build_subplot():
    ...
    A = dict()
    A[0] = np.loadtxt('Final_plate_results\B\Plate_60x30_B1n0[Pc=1.0]_densities.dat')
    A[1] = np.loadtxt('Final_plate_results\B\Plate_60x30_B2n0[Pc=1.5]_densities.dat')
    A[2] = np.loadtxt('Final_plate_results\B\Plate_60x30_B3n0[Pc=2.0]_densities.dat')
    A[3] = np.loadtxt('Final_plate_results\B\Plate_60x30_B3n0[Pc=2.5]_densities.dat')
    ...
    fig, ((axs[0], axs[1], axs[2])) = plt.subplots(1, 3, figsize=(7,3.5))
