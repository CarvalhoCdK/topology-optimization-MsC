...
def build_subplot():
    ...
    A = dict()
    A[0] = np.loadtxt('Final_plate_results\C\Plate_60x30_Cc[0.00, Pc=0.00]_densities.dat')
    A[1] = np.loadtxt('Final_plate_results\C\Plate_60x30_Cc[0.25, Pc=1.00]_densities.dat')
