...
def build_subplot():
    ...
    A = dict()
    A[0] = np.loadtxt('Final_plate_results\A\Plate_60x30_A1n0[Pc=1.0]_densities.dat')
    A[1] = np.loadtxt('Final_plate_results\A\Plate_60x30_A2n0[Pc=1.5]_densities.dat')
    A[2] = np.loadtxt('Final_plate_results\A\Plate_60x30_A3n0[Pc=2.0]_densities.dat')
    A[3] = np.loadtxt('Final_plate_results\A\Plate_60x30_A3n0[Pc=2.5]_densities.dat')
